...
const PharmaForecasting = () => {
  // const handleOpenPDF = () => {
  //   window.open('Pharma Forecasting_Training Plan..pdf','_blank');
  // };
const handleOpenPDF = () => {
  const link = document.createElement("a");
  link.href = '/Pharma Forecasting_Training Plan..pdf';   // file must be inside public/
  link.download = 'Pharma Forecasting_Training Plan..pdf';
  link.click();
};
    ...
    <Container fluid className="bg-light">
      ...
      <Row className="py-5">
        <Col md={6} className="text-start px-5">
          <h1 className="mb-3">Pharma Forecasting Training Program</h1>
          <h5 className="lead">
          ...
          <ul className="list-unstyled my-4 fs-5">
            ...
            <li><strong>✅Eligibility:</strong> Graduate in Pharma/Life Sciences/Statistics/Business</li>
            <li><strong>✅Starting Salary:</strong> Up to ₹40,000 per month<sup>*</sup></li>
          </ul>
 ...
 <Container className="my-5 p-5">
  <h1 className="text-center mb-4 p-5">Career Opportunities in Pharma Forecasting</h1>
        ...
        <Col md={6}>
          <Accordion>
            <Accordion.Item eventKey="0" className="mb-3 rounded p-2">
              ...
              <Accordion.Body>
                This program is designed for students and professionals aiming to build a career in pharma forecasting, market research, or business analytics.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="1" className="mb-3 rounded p-2">
              <Accordion.Header>What tools will I learn?</Accordion.Header>
              <Accordion.Body>
                You will gain practical experience in Excel, Power BI, Python, R, and forecasting models widely used in the industry.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="2" className="mb-3 rounded p-2">
              ...
              <Accordion.Body>
                Graduates can pursue roles such as Forecasting Analyst, Market Research Analyst, Business Analyst – Pharma, and Data Analyst in healthcare companies.
              </Accordion.Body>
            </Accordion.Item>
            <Accordion.Item eventKey="3" className="mb-3 rounded p-2">
              <Accordion.Header>What support is provided?</Accordion.Header>
              <Accordion.Body>
                You will receive career mentorship, industry case studies, live projects, and placement assistance with MedLabs’ partner organizations.
              </Accordion.Body>
            </Accordion.Item>
          </Accordion>
        </Col>
