...
function ApplyNow({ show, handleClose, onSuccess }) {   // 👈 accept onSuccess
  const [formData, setFormData] = useState({
    name: "",
    email: "",
    phone: "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://backend-medlabs.onrender.com/api/submit",
        formData
      );
    ...
    <Modal show={show} onHide={handleClose} centered>
      ...
      <Modal.Body>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <br />
          <Form.Text className="text-muted">
            By continuing, I agree to the <a href="/TermsCondition">T&Cs</a> and{" "}
